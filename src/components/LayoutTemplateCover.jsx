...
export default function LayoutTemplateCover({ onClose }) {
  ...
  const data = {
    ...
    description: [
      ...
      { type: "image", src: "src/assets/t1.jpg", alt: "foto: t1" },
      ...
      { type: "image", src: "src/assets/t2.jpg", alt: "foto: t2" },
      ...
      { type: "image", src: "src/assets/t3.jpg", alt: "foto: t3" },
      ...
      { type: "image", src: "src/assets/t4.jpg", alt: "foto: t4" },
      ...
      { type: "image", src: "src/assets/t5.jpg", alt: "foto: t5" },
      ...
      { type: "image", src: "src/assets/t6.jpg", alt: "foto: t6" },
